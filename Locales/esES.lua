...
-- =====================================
-- [v3.1] Grupos Jefe / Arena + IU de perfiles
-- =====================================
L["CAT_BOSS"]                   = "Jefe"
L["CAT_ARENA"]                  = "Arena"
L["CAT_PROFILES"]               = "Perfiles"
L["SUBLABEL_STACKING"]          = "Apilado"
L["SLIDER_NUMBARS"]             = "Número de barras"
L["GROWTH_DIRECTION"]           = "Dirección de crecimiento"
L["GROWTH_UP"]                  = "Hacia arriba"
L["GROWTH_DOWN"]                = "Hacia abajo"
L["SLIDER_SPACING"]             = "Espaciado de barras"
L["INFO_BOSS"]                  = "Las barras de jefe aparecen durante los encuentros. Hasta 5 barras apiladas (boss1-boss5)."
L["INFO_ARENA"]                 = "Las barras de enemigos de arena aparecen en combates de arena. Hasta 5 barras apiladas (arena1-arena5)."
L["PROFILES_DESC"]              = "Los perfiles guardan toda la configuración de TomoCastbar. Crea configuraciones con nombre o carga una por especialización."
L["PROFILE_ACTIVE_LABEL"]       = "Perfil activo: %s"
L["PROFILE_SELECT"]             = "Perfil seleccionado"
L["PROFILE_LOAD_BTN"]           = "Cargar selección"
L["PROFILE_DELETE_BTN"]         = "Eliminar selección"
L["HEADER_PROFILES_CREATE"]     = "Crear / Duplicar"
L["PROFILE_NAME_FIELD"]         = "Nombre del nuevo perfil"
L["PROFILE_CREATE_BTN"]         = "Crear"
L["PROFILE_DUPLICATE_BTN"]      = "Duplicar selección"
L["PROFILE_SPEC_HEADER"]        = "Perfiles por especialización (auto)"
L["PROFILE_SPEC_INFO"]          = "Asigna un perfil a tu especialización actual. Se carga automáticamente al cambiar de especialización."
L["PROFILE_SPEC_CURRENT"]       = "Especialización actual: %s → %s"
L["PROFILE_SPEC_ASSIGN"]        = "Asignar especialización actual a"
L["PROFILE_SPEC_CLEAR"]         = "Quitar asignación"
L["PROFILE_NONE"]               = "(ninguno)"
L["PROFILE_CREATED"]            = "Perfil creado: %s"
L["PROFILE_DELETED"]            = "Perfil eliminado: %s"
L["PROFILE_LOADED"]             = "Perfil cargado: %s"
L["PROFILE_CANNOT_DELETE"]      = "No se puede eliminar el perfil predeterminado."
L["PROFILE_NAME_EMPTY"]         = "Introduce un nombre de perfil."
L["PROFILE_EXISTS"]             = "Ya existe un perfil con ese nombre."
L["PROFILE_SPEC_ASSIGNED"]      = "Especialización asignada al perfil: %s"
L["PROFILE_SPEC_UNASSIGNED"]    = "Asignación de especialización eliminada."
