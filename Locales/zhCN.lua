...
-- =====================================
-- [v3.1] 首领/竞技场分组 + 配置文件界面
-- =====================================
L["CAT_BOSS"]                   = "首领"
L["CAT_ARENA"]                  = "竞技场"
L["CAT_PROFILES"]               = "配置文件"
L["SUBLABEL_STACKING"]          = "堆叠"
L["SLIDER_NUMBARS"]             = "条数"
L["GROWTH_DIRECTION"]           = "增长方向"
L["GROWTH_UP"]                  = "向上"
L["GROWTH_DOWN"]                = "向下"
L["SLIDER_SPACING"]             = "条间距"
L["INFO_BOSS"]                  = "首领施法条在首领战中显示。最多5条堆叠（boss1-boss5）。"
L["INFO_ARENA"]                 = "竞技场敌方施法条在竞技场中显示。最多5条堆叠（arena1-arena5）。"
L["PROFILES_DESC"]              = "配置文件保存整个 TomoCastbar 配置。创建命名配置，或为每个专精自动加载一个。"
L["PROFILE_ACTIVE_LABEL"]       = "当前配置文件：%s"
L["PROFILE_SELECT"]             = "所选配置文件"
L["PROFILE_LOAD_BTN"]           = "加载所选"
L["PROFILE_DELETE_BTN"]         = "删除所选"
L["HEADER_PROFILES_CREATE"]     = "创建 / 复制"
L["PROFILE_NAME_FIELD"]         = "新配置文件名称"
L["PROFILE_CREATE_BTN"]         = "创建"
L["PROFILE_DUPLICATE_BTN"]      = "复制所选"
L["PROFILE_SPEC_HEADER"]        = "专精配置文件（自动切换）"
L["PROFILE_SPEC_INFO"]          = "将配置文件分配给当前专精。切换专精时自动加载。"
L["PROFILE_SPEC_CURRENT"]       = "当前专精：%s → %s"
L["PROFILE_SPEC_ASSIGN"]        = "将当前专精分配给"
L["PROFILE_SPEC_CLEAR"]         = "清除专精分配"
L["PROFILE_NONE"]               = "（无）"
L["PROFILE_CREATED"]            = "已创建配置文件：%s"
L["PROFILE_DELETED"]            = "已删除配置文件：%s"
L["PROFILE_LOADED"]             = "已加载配置文件：%s"
L["PROFILE_CANNOT_DELETE"]      = "无法删除默认配置文件。"
L["PROFILE_NAME_EMPTY"]         = "请输入配置文件名称。"
L["PROFILE_EXISTS"]             = "已存在同名配置文件。"
L["PROFILE_SPEC_ASSIGNED"]      = "已将专精分配给配置文件：%s"
L["PROFILE_SPEC_UNASSIGNED"]    = "已清除专精分配。"
