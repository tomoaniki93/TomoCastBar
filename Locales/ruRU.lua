...
-- =====================================
-- [v3.1] Группы боссов / арены + интерфейс профилей
-- =====================================
L["CAT_BOSS"]                   = "Босс"
L["CAT_ARENA"]                  = "Арена"
L["CAT_PROFILES"]               = "Профили"
L["SUBLABEL_STACKING"]          = "Размещение"
L["SLIDER_NUMBARS"]             = "Количество полос"
L["GROWTH_DIRECTION"]           = "Направление роста"
L["GROWTH_UP"]                  = "Вверх"
L["GROWTH_DOWN"]                = "Вниз"
L["SLIDER_SPACING"]             = "Интервал между полосами"
L["INFO_BOSS"]                  = "Полосы боссов появляются во время сражений. До 5 полос (boss1-boss5)."
L["INFO_ARENA"]                 = "Полосы противников на арене появляются в матчах. До 5 полос (arena1-arena5)."
L["PROFILES_DESC"]              = "Профили сохраняют все настройки TomoCastbar. Создавайте именованные профили или загружайте по одному на специализацию."
L["PROFILE_ACTIVE_LABEL"]       = "Активный профиль: %s"
L["PROFILE_SELECT"]             = "Выбранный профиль"
L["PROFILE_LOAD_BTN"]           = "Загрузить выбранный"
L["PROFILE_DELETE_BTN"]         = "Удалить выбранный"
L["HEADER_PROFILES_CREATE"]     = "Создать / Дублировать"
L["PROFILE_NAME_FIELD"]         = "Имя нового профиля"
L["PROFILE_CREATE_BTN"]         = "Создать"
L["PROFILE_DUPLICATE_BTN"]      = "Дублировать выбранный"
L["PROFILE_SPEC_HEADER"]        = "Профили специализаций (авто)"
L["PROFILE_SPEC_INFO"]          = "Назначьте профиль текущей специализации. Он загрузится автоматически при смене специализации."
L["PROFILE_SPEC_CURRENT"]       = "Текущая спец.: %s → %s"
L["PROFILE_SPEC_ASSIGN"]        = "Назначить текущую спец. на"
L["PROFILE_SPEC_CLEAR"]         = "Снять назначение"
L["PROFILE_NONE"]               = "(нет)"
L["PROFILE_CREATED"]            = "Профиль создан: %s"
L["PROFILE_DELETED"]            = "Профиль удалён: %s"
L["PROFILE_LOADED"]             = "Профиль загружен: %s"
L["PROFILE_CANNOT_DELETE"]      = "Невозможно удалить профиль Default."
L["PROFILE_NAME_EMPTY"]         = "Введите имя профиля."
L["PROFILE_EXISTS"]             = "Профиль с таким именем уже существует."
L["PROFILE_SPEC_ASSIGNED"]      = "Спец. назначена профилю: %s"
L["PROFILE_SPEC_UNASSIGNED"]    = "Назначение спец. снято."
