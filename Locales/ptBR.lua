...
-- =====================================
-- [v3.1] Grupos Chefe / Arena + IU de perfis
-- =====================================
L["CAT_BOSS"]                   = "Chefe"
L["CAT_ARENA"]                  = "Arena"
L["CAT_PROFILES"]               = "Perfis"
L["SUBLABEL_STACKING"]          = "Empilhamento"
L["SLIDER_NUMBARS"]             = "Número de barras"
L["GROWTH_DIRECTION"]           = "Direção de crescimento"
L["GROWTH_UP"]                  = "Para cima"
L["GROWTH_DOWN"]                = "Para baixo"
L["SLIDER_SPACING"]             = "Espaçamento das barras"
L["INFO_BOSS"]                  = "As barras de chefe aparecem durante os encontros. Até 5 barras empilhadas (boss1-boss5)."
L["INFO_ARENA"]                 = "As barras de inimigos na arena aparecem em partidas de arena. Até 5 barras empilhadas (arena1-arena5)."
L["PROFILES_DESC"]              = "Os perfis salvam toda a configuração do TomoCastbar. Crie configurações nomeadas ou carregue uma por especialização."
L["PROFILE_ACTIVE_LABEL"]       = "Perfil ativo: %s"
L["PROFILE_SELECT"]             = "Perfil selecionado"
L["PROFILE_LOAD_BTN"]           = "Carregar seleção"
L["PROFILE_DELETE_BTN"]         = "Excluir seleção"
L["HEADER_PROFILES_CREATE"]     = "Criar / Duplicar"
L["PROFILE_NAME_FIELD"]         = "Nome do novo perfil"
L["PROFILE_CREATE_BTN"]         = "Criar"
L["PROFILE_DUPLICATE_BTN"]      = "Duplicar seleção"
L["PROFILE_SPEC_HEADER"]        = "Perfis por especialização (auto)"
L["PROFILE_SPEC_INFO"]          = "Atribua um perfil à sua especialização atual. Ele é carregado automaticamente ao trocar de especialização."
L["PROFILE_SPEC_CURRENT"]       = "Especialização atual: %s → %s"
L["PROFILE_SPEC_ASSIGN"]        = "Atribuir especialização atual a"
L["PROFILE_SPEC_CLEAR"]         = "Remover atribuição"
L["PROFILE_NONE"]               = "(nenhum)"
L["PROFILE_CREATED"]            = "Perfil criado: %s"
L["PROFILE_DELETED"]            = "Perfil excluído: %s"
L["PROFILE_LOADED"]             = "Perfil carregado: %s"
L["PROFILE_CANNOT_DELETE"]      = "Não é possível excluir o perfil padrão."
L["PROFILE_NAME_EMPTY"]         = "Digite um nome de perfil."
L["PROFILE_EXISTS"]             = "Já existe um perfil com esse nome."
L["PROFILE_SPEC_ASSIGNED"]      = "Especialização atribuída ao perfil: %s"
L["PROFILE_SPEC_UNASSIGNED"]    = "Atribuição de especialização removida."
