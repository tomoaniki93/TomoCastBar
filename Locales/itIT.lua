...
-- =====================================
-- [v3.1] Gruppi Boss / Arena + UI profili
-- =====================================
L["CAT_BOSS"]                   = "Boss"
L["CAT_ARENA"]                  = "Arena"
L["CAT_PROFILES"]               = "Profili"
L["SUBLABEL_STACKING"]          = "Impilamento"
L["SLIDER_NUMBARS"]             = "Numero di barre"
L["GROWTH_DIRECTION"]           = "Direzione di crescita"
L["GROWTH_UP"]                  = "Verso l'alto"
L["GROWTH_DOWN"]                = "Verso il basso"
L["SLIDER_SPACING"]             = "Spaziatura barre"
L["INFO_BOSS"]                  = "Le barre dei boss appaiono durante gli scontri. Fino a 5 barre impilate (boss1-boss5)."
L["INFO_ARENA"]                 = "Le barre dei nemici in arena appaiono nelle partite in arena. Fino a 5 barre impilate (arena1-arena5)."
L["PROFILES_DESC"]              = "I profili salvano l'intera configurazione di TomoCastbar. Crea configurazioni con nome o caricane una per specializzazione."
L["PROFILE_ACTIVE_LABEL"]       = "Profilo attivo: %s"
L["PROFILE_SELECT"]             = "Profilo selezionato"
L["PROFILE_LOAD_BTN"]           = "Carica selezione"
L["PROFILE_DELETE_BTN"]         = "Elimina selezione"
L["HEADER_PROFILES_CREATE"]     = "Crea / Duplica"
L["PROFILE_NAME_FIELD"]         = "Nome nuovo profilo"
L["PROFILE_CREATE_BTN"]         = "Crea"
L["PROFILE_DUPLICATE_BTN"]      = "Duplica selezione"
L["PROFILE_SPEC_HEADER"]        = "Profili per specializzazione (auto)"
L["PROFILE_SPEC_INFO"]          = "Assegna un profilo alla tua specializzazione attuale. Si carica automaticamente quando cambi specializzazione."
L["PROFILE_SPEC_CURRENT"]       = "Spec attuale: %s → %s"
L["PROFILE_SPEC_ASSIGN"]        = "Assegna la spec attuale a"
L["PROFILE_SPEC_CLEAR"]         = "Rimuovi assegnazione"
L["PROFILE_NONE"]               = "(nessuno)"
L["PROFILE_CREATED"]            = "Profilo creato: %s"
L["PROFILE_DELETED"]            = "Profilo eliminato: %s"
L["PROFILE_LOADED"]             = "Profilo caricato: %s"
L["PROFILE_CANNOT_DELETE"]      = "Impossibile eliminare il profilo predefinito."
L["PROFILE_NAME_EMPTY"]         = "Inserisci un nome profilo."
L["PROFILE_EXISTS"]             = "Esiste già un profilo con questo nome."
L["PROFILE_SPEC_ASSIGNED"]      = "Spec assegnata al profilo: %s"
L["PROFILE_SPEC_UNASSIGNED"]    = "Assegnazione spec rimossa."
